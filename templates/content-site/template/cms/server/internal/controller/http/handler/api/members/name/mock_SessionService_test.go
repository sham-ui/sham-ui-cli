...
// UpdateName provides a mock function with given fields: w, r, name
func (_m *MockSessionService) UpdateName(w http.ResponseWriter, r *http.Request, name string) error {
	ret := _m.Called(w, r, name)
